      ...
      <main className="container-app py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-ink dark:bg-focus-500 text-white text-sm font-medium px-4 py-2.5 hover:bg-focus-700 transition w-full md:w-auto"
          >
